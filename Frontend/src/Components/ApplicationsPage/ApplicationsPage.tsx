...
import { GET_ALL_APPLICATIONS, GET_ALL_USER_APPLICATIONS, UPDATE_APPLICATION_STATUS, WITHDRAW_APPLICATION } from './ApplicationPageAPI/ApplicationPageAPI';
...
const ApplicationsPage: React.FC = () => {
  const {userId,organizationId,userType} = useContext(TokenContext);
  ...
  const handleDownloadResume = async (fileName: any) => {
    ...
    try {
      ...
      window.open(data.generateDownloadUrl.downloadUrl,"_self");
    } catch (error) {
